...
namespace TumblrClone.MODELS.DAO
{
    public class DataProvider
    {
        ...
        private String connectionSTR = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=B:\ASP Project\TumblrClone\App_Data\TumblrClone.mdf;Integrated Security=True";
